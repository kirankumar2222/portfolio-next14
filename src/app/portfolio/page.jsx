            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <p className="w-80 md:w-96 lg:w-[200px] lg:text-lg xl:w-[400px]">
                    {item.desc}
                  </p>
                  <Link href={item.link} className="flex justify-end">
                    <button className="p-2 text-sm md:text-md lg:text-lg bg-white text-gray-600 font-semibold m-4 rounded">
                      See demo
                    </button>
                  </Link>
                </div>
